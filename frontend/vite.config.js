...
function keycloakDevProxy(target) {
        ...
        configure: (proxy) => {
            ...
            proxy.on('proxyRes', (proxyRes, req, res) => {
                ...
                proxyRes.on('end', () => {
                    ...
                    const textual = type.includes('json') ||
                        type.includes('text') ||
                    ...
                    if (textual) {
                        ...
                        text = text
                            ...
                            .replaceAll("'/resources/", "'/keycloak/resources/")
                            .replaceAll('=/realms/', '=/keycloak/realms/');
                        if (text.includes('id="kc-form-login"') &&
                    ...
                    if (cookies) {
                        ...
                        headers['set-cookie'] = list.map((cookie) => cookie
                            .replace(/;\s*Domain=[^;]*/gi, '')
                            .replace(/;\s*Secure/gi, '')
...
export default defineConfig(({ mode }) => {
    ...
    const proxy = keycloakUrl.includes('loca.lt')
