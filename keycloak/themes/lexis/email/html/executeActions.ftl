    ...
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin:0 0 24px;">
        <tr>
            <td align="center" style="background-color:#0b1f3a;border-radius:4px;">
                <a href="${link}" style="display:block;padding:12px 24px;font-family:'IBM Plex Sans',Arial,Helvetica,sans-serif;font-size:15px;line-height:20px;font-weight:600;color:#ffffff;text-decoration:none;">Đặt mật khẩu</a>
            </td>
        </tr>
    </table>
