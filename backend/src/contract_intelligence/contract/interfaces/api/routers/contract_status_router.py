...
@router.get("/{dossier_id}/jobs/{job_id}", response_model=ApiResponse[dict])
async def get_job_status(dossier_id: str, job_id: str, _status_code: int = status.HTTP_200_OK) -> ApiResponse[dict]:
