...
Chức năng: upload contract + nhiều appendix, poll job, facts/findings, xem PNG với line bbox, review confirm/correct/reject/needs-more-evidence, lịch sử và approval. Backend quyết định quyền và approval gate. Token chỉ ở React memory; tải lại trang cần nhập lại.
